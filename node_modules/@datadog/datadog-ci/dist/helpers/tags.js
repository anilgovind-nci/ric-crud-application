...
exports.REQUIRED_GIT_TAGS = {
    [exports.GIT_REPOSITORY_URL]: true,
    [exports.GIT_BRANCH]: true,
    [exports.GIT_SHA]: true,
    [exports.GIT_COMMIT_AUTHOR_EMAIL]: true,
    [exports.GIT_COMMIT_AUTHOR_NAME]: true,
    [exports.GIT_COMMIT_COMMITTER_EMAIL]: true,
    [exports.GIT_COMMIT_COMMITTER_NAME]: true,
};
/**
...
const readJsonFile = (context, filename) => {
    filename = path_1.default.posix.normalize(filename); // resolve relative paths
