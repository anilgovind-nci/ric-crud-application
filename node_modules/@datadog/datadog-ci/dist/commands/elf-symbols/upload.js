...
class UploadCommand extends clipanion_1.Command {
    ...
    getMappingMetadata(elfFileMetadata) {
        ...
        return {
            ...
            filename: path_1.default.basename(elfFileMetadata.filename),
    ...
    getElfSymbolFiles(symbolsLocation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (stat.isDirectory()) {
                ...
                paths = glob_1.default.sync((0, utils_1.buildPath)(symbolsLocation, '**'), { dot: true, strict: false, silent: true });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const results = yield (0, concurrency_1.doWithMaxConcurrency)(this.maxConcurrency, elfFilesMetadata, (fileMetadata) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const outputFilename = (0, elf_1.getOutputFilenameFromBuildId)((0, elf_1.getBuildId)(fileMetadata));
