import { BaseResult, BasicAuthCredentials, CookiesObject, ExecutionRule, MobileTestWithOverride, Result, ResultInBatch, ResultInBatchSkippedBySelectiveRerun, RetryConfig, ServerResult, Test, TestNotFound, TestSkipped, TestWithOverride, UserConfigOverride } from '../interfaces';
...
export declare const toBoolean: (env: string | undefined) => boolean | undefined;
export declare const toNumber: (env: string | undefined) => number | undefined;
export declare const toExecutionRule: (env: string | undefined) => ExecutionRule | undefined;
export declare const toStringMap: (env: string | undefined) => StringMap | undefined;
type StringMap = {
    [key: string]: string;
};
type AccumulatorBaseConfigOverride = Omit<UserConfigOverride, 'retry' | 'basicAuth' | 'cookies' | 'setCookies' | 'mobileApplicationVersion' | 'mobileApplicationVersionFilePath' | 'tunnel'> & {
