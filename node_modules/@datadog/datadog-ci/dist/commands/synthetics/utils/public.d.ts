...
export declare const getTestAndOverrideConfig: (api: APIHelper, { config, testOverrides, id, suite }: TriggerConfig, reporter: MainReporter, summary: InitialSummary, isTunnelEnabled?: boolean) => Promise<TestNotFound | TestSkipped | TestWithOverride>;
