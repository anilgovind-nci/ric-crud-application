...
class MeasureCommand extends clipanion_1.Command {
    constructor() {
        super(...arguments);
        this.level = clipanion_1.Option.String('--level');
        this.metrics = clipanion_1.Option.Array('--metrics', { hidden: true });
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.path[0] === 'metric') {
                this.context.stdout.write(chalk_1.default.yellow(`[WARN] The "metric" command is deprecated. Please use the "measure" command instead.\n`));
            }
            ...
            const cliMeasures = this.measures || this.metrics;
            ...
            if (this.metrics) {
                this.context.stdout.write(`${chalk_1.default.yellow.yellow(`[WARN] The "--metrics" flag is deprecated. Please use "--measures" flag instead.\n`)}`);
            }
...
MeasureCommand.paths = [['measure'], ['metric']];
