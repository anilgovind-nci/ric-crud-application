    ...
    execute() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.interactive) {
                ...
                const region = (_c = (_b = this.region) !== null && _b !== void 0 ? _b : this.config.region) !== null && _c !== void 0 ? _c : process.env[constants_1.AWS_DEFAULT_REGION_ENV_VAR];
                this.region = region;
                if (!hasSpecifiedFunctions) {
                    ...
                    try {
                        const lambdaClientConfig = {
                            ...
                            retryStrategy: constants_1.EXPONENTIAL_BACKOFF_RETRY_STRATEGY,
                        };
