...
class UploadSarifReportCommand extends clipanion_1.Command {
    constructor() {
        ...
        this.service = clipanion_1.Option.String('--service', 'datadog-ci');
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.context.stdout.write((0, renderer_1.renderCommandInfo)(this.basePaths, this.service, env, sha, this.maxConcurrency, this.dryRun, this.noVerify));
