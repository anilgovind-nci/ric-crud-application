...
class UploadCommand extends clipanion_1.Command {
    ...
    performSoUpload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const soFiles = glob_1.default.sync((0, utils_1.buildPath)(this.symbolsLocation, '**/*.so'));
            ...
            try {
                const results = yield (0, concurrency_1.doWithMaxConcurrency)(this.maxConcurrency, soFiles, (soFileName) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const tempFilePath = (0, utils_1.buildPath)(tempDir, (0, path_1.basename)(soFileName));
                    ...
                    const baseFilename = path_1.default.basename(soFileName);
